...
- **Surcharges de longueur en place** : nav de section mobile `3.5rem` (calibrage B.10), infobulle de la carte `36px`, rangée de filtres du catalogue `32px` (puces étroites : un fondu long en effacerait une entière). Toutes les surcharges de **couleur** ont disparu.
